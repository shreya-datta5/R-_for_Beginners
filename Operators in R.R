...
# R Operatoes - -R arithmetic Operators Example for vectors
a <- c(8, 9, 6)
b <- c(2, 4, 5)
...
# Relational operators are those that find out the relation between two operands provided to them.
# The output is boolean (TRUE or FALSE) for all of the Relational Operators in R programming.
...
# R Operators - R Relational Operators Example for vectors
a <- c(7.5, 3, 5)
b <- c(2, 7, 0)
...
a = 23:31 # create series of numbers from left operand to right operand
print(a)

a = c(25, 27, 76) # identifies if an element(b) belongs in a vector(a)
b = 27
print(b%in%a)
